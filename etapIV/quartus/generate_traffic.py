...
NUM_TESTS = 100000  #100 tysięcy, żeby potwierdzić szczelność
...
if __name__ == "__main__":
    ...
    #zamiana listy na zbiór dla szybszego wyszukiwania
    ...
    for _ in range(NUM_TESTS):
        ...
        if random.choice([True, False]):
            ...
            while True:
                ...
                # Jeśli wylosowany pakiet NIE ZNAJDUJE się w bazie zaufanych, przerywamy pętlę
